            ...
            <div class="mx-16 my-6 w-full max-w-4xl shadow bg-white border border-gray-200 rounded-lg">
                <div class="py-5 px-5 pb-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Make Offer</a>
                    </div>
                </div>
                <div class="w-full bg-white rounded-lg">
                    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg" id="defaultTab" data-tabs-toggle="#defaultTabContent" role="tablist">
                        @php 
                            ...
                            $baseUrl = URL::to('/') . "/" . $property['id'];
                            $curUrl = url()->current();
                            $activeStyles = "text-blue-600 border-b-2 border-blue-600";
                        @endphp
                        <li class="mr-2">
                            <a href="/{{$property['id'] }}" type="button" class="{{ $curUrl==$baseUrl ? $activeStyles : ''; }} inline-block font-medium p-4 rounded-tl-lg hover:bg-gray-100">About</a>
                        </li>
                        <li class="mr-2">
                            <a href="/{{ $property['id'] }}/Photos" type="button" class="{{ $curUrl==$baseUrl . '/Photos' ? $activeStyles : ''; }} inline-block p-4 hover:text-gray-600 hover:bg-gray-100">Photos</a>
                        </li>
                        <li class="mr-2">
                            <a href="/{{ $property['id'] }}/Contact" type="button" class="{{ $curUrl==$baseUrl . '/Contact' ? $activeStyles : ''; }} inline-block p-4 hover:text-gray-600 hover:bg-gray-100">Contact</a>
                        </li>
                    </ul>
                    <div>
                        @if($curUrl==$baseUrl)
