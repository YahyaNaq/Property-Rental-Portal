<x-layout title="Analytics">
    <div class="min-h-full">
        ...
        @include('dashboard/_header', ['heading' => 'Property Analytics'])
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            @if($property)             
                <h5 class="my-4 text-2xl font-semibold">Property currently rented by you</h5>
            ...
            @else
                <div>
                    <h5 class="text-lg mb-3 ">You haven't rented any property yet.</h5>
                    <a href="/" target="_blank" class="inline-flex items-center font-medium w-[5.5rem] px-3 py-2 text-center rounded-lg text-sm text-white bg-blue-700 hover:bg-blue-800">Rent Now</a>
                </div>
            @endif
