        ...
        <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <div class="flex gap-2">
                    ...
                    @else
                    <a href="/" class="text-white flex max-w-xs items-center rounded-md px-3 py-2 bg-indigo-700 hover:bg-indigo-800 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:ring-offset-indigo-800">Login</a>
                    <a href="/register" class="text-white flex max-w-xs items-center rounded-md px-3 py-2 bg-indigo-700 hover:bg-indigo-800 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:ring-offset-indigo-800">Register</a>
                    @endif
                </div>
                @else
