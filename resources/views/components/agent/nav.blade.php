    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            ...
            <div class="ml-10 flex items-baseline space-x-4">
                ...
                @auth('agents')
                    <a href="/agent/dashboard" class="{{ Str::contains($curUrl, $baseUrl . '/agent/dashboard') ? $activeStyles : $defaultStyles; }} rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Dashboard</a>
                @endauth
